...
export default function New() {
    ...
    return (
        <React.Fragment>
            <div>
                <Page title="Create selling plan group"
                    divider
                            ...
                            <Card sectioned>
                                <FormLayout>
                                    ...
                                    <TextField label="Plan Name"
                                        ...
                                        autoComplete="off" value={setllingPlan.plan_name} placeholder="Subscribe and save"
                                    />
                                    <TextField label="Plan selector title" onChange={(value) => setSetllingPlan({ ...setllingPlan, plan_selector_name: value })} autoComplete="off" value={setllingPlan.plan_selector_name} placeholder="Deliver every" />
                                </FormLayout>
                            </Card>
                        </Layout.AnnotatedSection>
                        <Layout.AnnotatedSection
                                                                        ...
                                                                        <Stack>
                                                                            ...
                                                                            <Stack.Item>
                                                                                <ButtonGroup>
                                                                                    ...
                                                                                    {sellingPlansToCreateList.length > 1 && <Button destructive onClick={() => saveSellingPlanToCreateCancel()}>
                                                                                        Cancel
                                                                                    </Button>
                                                                                    }
                                                                                </ButtonGroup>
                                                                ...
                                                                <Card.Section>
                                                                    <FormLayout>
                                                                        ...
                                                                        <FormLayout.Group condensed >
                                                                            ...
                                                                            />
                                                                            <TextField label="Cutt off (in Days)" disabled={parseInt(sellingPlansToCreateObject.anchor_day) == 0}
                                                                                type='number' onChange={(value) => onChangeSellingPlanToCreate({ target: { name: "cutoff", value: value } })} value={sellingPlansToCreateObject.cutoff} autoComplete="off" />
                                                                        </FormLayout.Group>
                                                                    </FormLayout>
                                                                </Card.Section>
                                                                <Card.Section>
