...
export default function ShippingProfileListing() {
    ...
    return (
        <Page title="Shipping Profile"
            primaryAction={{ content: 'Create Shipping Profile', onAction: () => navigation(`/admin/shipping-profile-new?${window.urlParams}`) }}
        >
            <Card>
                <Card.Section >
                    <div style={{ borderRadius: '8px', border: '1px solid rgb(225 227 229)' }}>
                        <DataTable
                            ...
                            headings={[
                                <Text variant="bodyMd" as="span" fontWeight="semibold">Shipping Profile Name</Text>,
                                <Text variant="bodyMd" as="span" fontWeight="semibold">Selling Plans</Text>,
            ...
            >
                <Modal.Section>
                    <p>
                        Are you sure want to delete shipping profile?
                    </p>
                </Modal.Section>
            </Modal>}
